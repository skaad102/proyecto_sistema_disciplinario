...
<div class="container">
    ...
    // Variable para auto-mostrar la tabla después de operaciones
    $autoMostrar = false;
    ...
    // Mostrar automáticamente después de operaciones o cuando se presiona el botón
    if(isset($_POST['ver']) || $autoMostrar){
        $_POST['ver'] = true; // Forzar que se muestre
    }
    ?>
