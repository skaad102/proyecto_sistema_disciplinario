...
try {
    ...
    $cod_estudiante = intval($_GET['id']);
    $estudiante = obtenerEstudiantePorId($conexion, $cod_estudiante);
    ...
    echo json_encode(['error' => 'Error al obtener datos del estudiante: ' . $e->getMessage()], JSON_UNESCAPED_UNICODE);
}
exit;
