...
-- Create and select database so phpMyAdmin / mysql know where to import (fixes #1046 No database selected)
CREATE DATABASE IF NOT EXISTS `registro_faltas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `registro_faltas`;
